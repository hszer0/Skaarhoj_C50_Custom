...
void commandToggleTie1()
{
  AtemSwitcher.changeDownstreamKeyTie(1, !AtemSwitcher.getDownstreamKeyTie(1));
}

void commandToggleTie2()
{
  AtemSwitcher.changeDownstreamKeyTie(2, !AtemSwitcher.getDownstreamKeyTie(2));
}