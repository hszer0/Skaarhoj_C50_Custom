...
void setButtonColors()  {
  ...
  cmdSelect.setButtonColor(3, AtemSwitcher.getFadeToBlackState()>0 ? 2 : 5);     // Ftb button
  ...
  cmdSelect.setButtonColor(4, AtemSwitcher.getDownstreamKeyTie(2) ? (AtemSwitcher.getDownstreamKeyerStatus(2) ? 2 : 3) : 5);     
  

  if (!cmdSelect.buttonIsPressed(3))  {
    cmdSelect.setButtonColor(2, 5);   // de-highlight CUT button
  }
}
...
void commandDispatch()  {
  ...
  if (inputSelect.isButtonIn(1, busSelection))  { 
    if (AtemSwitcher.getPreviewTally(5)) {
      commandCut();
    }
    else
    {
  ...
  if (inputSelect.isButtonIn(2, busSelection))   { 
    if (AtemSwitcher.getPreviewTally(6)) {
      commandCut();
    }
    else
    {
  ...
  if (inputSelect.isButtonIn(3, busSelection))   { 
    if (AtemSwitcher.getPreviewTally(7)) {
      commandCut();
    }
    else
    {
  ...
  if (inputSelect.isButtonIn(4, busSelection))  { 
    if (AtemSwitcher.getPreviewTally(8)) {
      commandCut();
    }
    else
    {
  ...
  if (inputSelect.isButtonIn(5, busSelection))  { 
    if (AtemSwitcher.getPreviewTally(1)) {
      commandCut();
    }
    else
    {
  ...
  if (inputSelect.isButtonIn(6, busSelection))   { 
    if (AtemSwitcher.getPreviewTally(2)) {
      commandCut();
    }
    else
    {
  ...
  if (inputSelect.isButtonIn(7, busSelection))  { 
    if (AtemSwitcher.getPreviewTally(3)) {
      commandCut();
    }
    else
    {
  ...
  if (inputSelect.isButtonIn(8, busSelection))  { 
    if (AtemSwitcher.getPreviewTally(4)) {
      commandCut();
    }
    else
    {
